...
return [
    ...
    */
    ...
    'active_url' => 'El campo :attribute no es una URL válida.',
        ...
        |--------------------------------------------------------------------------
        |
        | Aquí puedes especificar mensajes de validación personalizados para los atributos utilizando
        | la convención "attribute.rule" para nombrar las líneas. Esto nos permite
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Las siguientes líneas de idioma se utilizan para reemplazar nuestro marcador de posición de atributo
